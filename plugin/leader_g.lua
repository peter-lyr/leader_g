...
require 'which-key'.register {
  ...
  ['<leader>gP'] = { function() F.git_pull_recursive 'clone' end, 'git_pull_recursive try clone', mode = { 'n', 'v', }, silent = true, },
  ...
  ['<leader>g<localleader>a'] = { function() F.git_add_commit_push() end, 'git_add_commit_push', mode = { 'n', 'v', }, silent = true, },
  ...
  ['<leader>gd'] = { function() require 'gitsigns'.diffthis() end, 'undo_stage_hunk', mode = { 'n', 'v', }, silent = true, },
  ['<leader>g<localleader>d'] = { function() require 'gitsigns'.diffthis('~1') end, 'undo_stage_hunk', mode = { 'n', 'v', }, silent = true, },
